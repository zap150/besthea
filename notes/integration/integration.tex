...
\begin{aligned}
  \frac{\partial G^{\dif\tau\dif t}_\alpha}{\partial \vn_\vy}(\tilde\vr,\delta) &= \frac{\partial g^{\dif\tau\dif t}}{\partial \rho}(\|\vr\|,\delta) \vn_\vy \cdot \nabla_\vy \|\vx-\vy\| 
  = -\frac{\partial g^{\dif\tau\dif t}}{\partial \rho}(\|\vr\|,\delta) \frac{(\vx-\vy)\cdot \vn_\vy}{\|\vx-\vy\|} \\

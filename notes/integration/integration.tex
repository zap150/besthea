...
\begin{equation} \label{eq:lim_double_primitive}
  \lim_{\|\tilde \vr\| \to 0_+} \frac{\partial \widetilde G^{\dif\hat\tau\dif\hat t}_1}{\partial \vn_\vy} = 0.
\end{equation}
This follows by estimating 
\begin{equation*}
	\left| \frac{\partial \widetilde G^{\dif\hat\tau\dif\hat t}_1}{\partial \vn_\vy}
	\right| \leq
	\left| \frac{\partial \widetilde{G}_1^{\dif \hat\tau \dif\hat t }}{\partial \vn_\vy}
	(\tilde\vr, \delta) \right| 
	\leq \left| 
	\frac{\left(\frac{\| \tilde \vr \|^2}{2} - \delta \right)
	\erf\left(\frac{\|\tilde \vr \|}{2 \sqrt{\delta}}  \right)
	+ \frac{\sqrt{\delta} \| \tilde \vr \|}{\sqrt{\pi}} 
	\exp \left( -\frac{\|\tilde \vr\|^2}{4 \delta} \right)}
	{4 \pi \|\tilde \vr\|^2 }
	 \right| = |g(\|\tilde\vr \|, \delta)|.
\end{equation*}
The limit of the function $g$ for $\rho = \|\tilde \vr\| \rightarrow 0+$ is zero. Indeed l'Hospital's rule yields
\begin{align*}
	\lim_{\rho \rightarrow 0+} g(\rho,\delta) &=
	\lim_{\rho \rightarrow 0+} \frac{
	\left(\frac{\rho^2}{2}-\delta \right) \erf\left(\frac{\rho}{2 \sqrt{\delta}} \right)
	+ \frac{\sqrt{\delta} \rho}{\sqrt{\pi}} \exp \left( -\frac{\rho^2}{4 \delta} \right)}
	{4\pi \rho^2} \\ &= 
	\lim_{\rho \rightarrow 0+} \frac{2 \rho \erf\left(\frac{\rho}{2 \sqrt{\delta}}\right)
	...
	{8 \pi \rho} \\
	&= \lim_{\rho \rightarrow 0 +}\frac{1}{4 \pi} \erf\left(\frac{-\rho^2}{4\delta}\right) = 0.
\end{align*}
This gives \eqref{eq:lim_double_primitive}.
...
\begin{equation*}
  \lim_{\|\tilde \vr\| \to 0_+} \frac{\partial \widetilde G^{\dif\hat\tau}_1}{\partial \vn_\vy} = 0.
\end{equation*}

...
\begin{align*}
  ...
  = \alpha \bigg( \frac{\partial G^{\dif\tau}_\alpha}{\partial \vn_\vy} (\vr,0) - \frac{\partial G^{\dif\tau\dif t}_\alpha}{\partial \vn_\vy}(\vr,h_t) + \frac{\partial G^{\dif\tau\dif t}_\alpha}{\partial \vn_\vy}(\vr,0) \bigg).
\end{align*}
...
\begin{equation*}
  \lim_{\|\vr\| \to 0_+}\alpha \frac{\partial G^{\dif\tau}_\alpha}{\partial \vn_\vy}(\vr,\delta) = 0.
\end{equation*}

classdef be_assembler_tausch < handle
  ...
  methods
    function obj = be_assembler_tausch( mesh, kernel, test, trial, ...
      ...
      obj.size_xy( 2 ) = obj.size_zp( 2 );
      obj.size_xy( 3 ) = obj.size_zp( 3 ) * length_nf_1d;
      obj.size_xy( 4 ) = obj.size_zp( 4 ) * length_nf_2d;
      ...
      for i = 1 : 4
        obj.x_ref{ i } = cell( obj.n_simplex, 1 );
        obj.y_ref{ i } = cell( obj.n_simplex, 1 );
        obj.zp{ i } = cell( obj.n_simplex, 1 );
        obj.weight{ i } = cell( obj.n_simplex, 1 );
      end
      ...
      for i_simplex = 1 : obj.n_simplex
        ...
        for i_ksi = 1 : l1d
          for i_w = 1 : l1d
            ...
            ksi = xref1d( i_ksi );
            [ zp_single, jac ] = ...
              ksi_w_to_zp( obj, ksi, w, type, i_simplex );
            obj.zp{ type }{ i_simplex }( counter_zp, : ) = zp_single;
            for i_wb = 1 : l2d
              wb = [ 1 1; 0 1 ] * xref2d( i_wb );
              [ x_single, y_single ] = ...
                ksi_w_wb_to_x_y( obj, ksi, w, wb, type, i_simplex );
              obj.x_ref{ type }{ i_simplex }( counter_xy, : ) = x_single;
              obj.y_ref{ type }{ i_simplex }( counter_xy, : ) = y_single;
              obj.weight{ type }{ i_simplex }( counter_xy, : ) = ...

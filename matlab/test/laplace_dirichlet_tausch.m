function [ dir, neu, repr, err_bnd, err_vol ] = ...
  laplace_dirichlet_tausch( level )
%function [ V, K ] = laplace_dirichlet_tausch( level )
...
beas_v_laplace = be_assembler_tausch( mesh, kernel_laplace_sl, ...
  basis_p0, basis_p0, order_nf_1d, order_nf_2d, order_nf_3d, order_ff );
fprintf( 1, 'Assembling V\n' );
tic;
V = beas_v_laplace.assemble( );
fprintf( 1, '  done in %f s.\n', toc );

beas_k_laplace = be_assembler_tausch( mesh, kernel_laplace_dl, ...
  basis_p0, basis_p1, order_nf_1d, order_nf_2d, order_nf_3d, order_ff );

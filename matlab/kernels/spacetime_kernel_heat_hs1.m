classdef spacetime_kernel_heat_hs1 < spacetime_kernel & matlab.mixin.Copyable
  ...
  methods
    function obj = spacetime_kernel_heat_hs1( alpha )
      obj.alpha = alpha;
      obj.ht = 0;
      obj.d = 0;
    end
  ...
  methods (Access = protected)
    function cp = copyElement( obj )
      cp = spacetime_kernel_heat_hs1( obj.alpha );
      cp.ht = obj.ht;
      cp.d = obj.d;
    end
  end
